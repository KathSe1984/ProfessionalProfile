...
<p align="center"> <img src="./DataViz/0-WordCloud.png" alt="my wordcloud" width="750"/> </p>

My name is $\fcolorbox{Turquoise}{}{\textsf{Kathrin Seibt}}$ and I'm a **computational biologist** with a background in molecular biology. My research focus has been on comparative genomics, transposable elements (repetitive DNA sequences), and molecular markers. 
...
I am programming in $\fcolorbox{Turquoise}{}{\textsf{Python}}$ and $\fcolorbox{Turquoise}{}{\textsf{R}}$ and have a general interest in problem solving, data mining, and visualization. In order to utilize various software tools and to integrate command line tools, I am used to working both in a **Windows** and a **Linux** environment. Consequently, I particularly appreciate cross-platform tools. For data visualization and documentation I use common packages such as **matplotlib**, **ggplot2** and **RMarkDown**. 
...
I enjoy **data mining** and love to create **visualizations** that reveal and illustrate interesting findings. I want to highlight my recently developed cross-platform bioinformatic visualization tool $\fcolorbox{Turquoise}{}{\textsf{FlexiDot}}$ available on [GitHub](https://github.com/molbio-dresden/flexidot).
...
This schematic representation created with **Inkscape and Python scripting** illustrates the modular similarities between the different families of short transposable elements (*right*) and links them to the plant orders where I have detected them with a custom **Python workflow** (*left side*).<sup>[3](#myfootnote3)</sup>

<p align="center"> <img src="./DataViz/5-Angio_SINE_Phylogeny.png" alt="phylogenetic distribution of Angio-SINEs" width="750"/> </p>
...
I was able to use our FlexiDot tool to identify and illustrate modular similarities of short transposon families (Angio-SINEs) across a wide variety plant species. Here, the dotplot depicting the modularity is complemented by a heatmap of the sequence similarities.<sup>[2](#myfootnote2)</sup><sup>,</sup><sup>[3](#myfootnote3)</sup> 

<p align="center"> <img src="./DataViz/4-Angio_SINE_FlexiDot.png" alt="FlexiDot illustration of Angio-SINEs" width="750"/> </p>
...
<p align="center"> <img src="./DataViz/7-Mechanism_SINE_LINE_white.png" alt="life cycle of SINE and LINE transposons" width="750"/> </p>

This one depicts a mechanism for genomic changes by transposable elements.

<p align="center"> <img src="./DataViz/8-SINE-Transduction.png" alt="SINE-mediated sequence transduction" width="750"/> </p>
...
<p align="center"> <img src="./DataViz/9-Journey_Map.png" alt="Travel route for our parental leave in 2022" width="450"/> </p>
